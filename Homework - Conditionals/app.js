...
const studentName = "Dilpreet";  // this will remain consistent through the code
const maxScore = 100; // this will remain consistent through the code
const passingScore = 60; // this will remain consistent through the code
let earnedScore = 73; // this can change  through the code
let isExtraCredit = false; // this can change  through the code
...
console.log(`Final Earned Score: ${earnedScore}`);
// ----------------------------------------------------------
