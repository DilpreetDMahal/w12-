...
// fullName = "dil";
// console.log(fullName); //Uncaught TypeError: Assignment to constant variable.
...
favoriteMovie = "Chainsaw Man: Rene Arc";
...
// Reassigning Product name failed becuase it was declared using const.
// ----------------------------------------------------------
...
// currentYear = 2026; //Uncaught TypeError: Assignment to constant variable.(Because of const, change to let)