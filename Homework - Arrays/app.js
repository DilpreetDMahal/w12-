...
const studentNames = ["Dil", "Alex", "Brian","Aaron", "Maliq", "Jae"];
...
studentNames.push("Will");
studentScores.push(66);
...
const studentRemoved = studentNames.shift();
const studentScoreRemoved = studentScores.shift();
// Store the removed name in a variable and log:
//   "Student removed: " + removedName
// Log: "Class size now: " + studentNames.length

console.log(`Student removed: ${studentRemoved}`);
console.log(`Class size now: ${studentNames.length}`);
// ----------------------------------------------------------
...
for (let i = 0 ; i < studentScores.length; i++)
{
    ...
    {
        console.log(`${studentNames[i]} was failing without curved score with ${studentScores[i]}.`);
    }
    else{
        console.log(`${studentNames[i]} was passing without curved score with ${studentScores[i]}.`);
    }
}