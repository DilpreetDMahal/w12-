...
const gameName = "Space Blaster"; // const because the game namis universally consistent.
let playerName = "Dil"; // let playerName can  change with different users playing the game
let playerScore = 0; // score can change
let highScore = 850; // high score can alter
const pointsPerKill = 25; // pointsperkill will most probably stay consistent as a point metrics
let livesRemaining = 3; // this can reduce according to the game
...
let levelBonus = playerScore * 0.5;
levelBonus += playerScore;
...
const gameMinutes = totalSeconds / 60;
const secondsLeft = totalSeconds % 60;

console.log(`Time left: ${Math.floor(gameMinutes)}min ${secondsLeft}sec`);
...
// accuracyPercent will have one decimal places and to round to 2 places we can use .toFixed(2)